...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Nunito-Bold', fontSize: 19, color: colors.darkText, marginBottom: 8, textAlign: 'center' },
  body: { fontFamily: 'Nunito-Regular', fontSize: 13, color: colors.mutedText, lineHeight: 20, marginBottom: 16, textAlign: 'center' },
  freezeCard: {
