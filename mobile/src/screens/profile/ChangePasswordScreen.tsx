...
const styles = StyleSheet.create({
  ...
  emailLabel: { fontFamily: 'Nunito-Bold', fontSize: 11, color: colors.midText, letterSpacing: 0.4, marginBottom: 5 },
  emailValue: { fontFamily: 'Nunito-Regular', fontSize: 15, color: colors.darkText },
