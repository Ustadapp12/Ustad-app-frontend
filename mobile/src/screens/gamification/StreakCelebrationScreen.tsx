...
const styles = StyleSheet.create({
  ...
  streakLabel:    { fontFamily: 'Nunito-Bold', fontSize: 22, color: 'white', marginBottom: 28 },
  ...
  repairedBubbleText: { fontFamily: 'Nunito-Bold', fontSize: 14, color: 'white', lineHeight: 19 },
