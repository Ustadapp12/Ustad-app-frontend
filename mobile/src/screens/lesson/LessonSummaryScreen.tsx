...
const styles = StyleSheet.create({
  ...
  star:         { fontSize: 52 },
  grade:        { fontFamily: 'Nunito-Bold', fontSize: 30, marginBottom: 14 },
  streakSavedBadge: {
  ...
  streakSavedBadgeText: { fontFamily: 'Nunito-Bold', fontSize: 15, color: STREAK_FROZEN_COLOR, textAlign: 'center' },
