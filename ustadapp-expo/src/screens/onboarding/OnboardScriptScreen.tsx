...
const SCRIPTS: {
  ...
  },
  {
    ...
    title: 'Amiri Quran',
    subtitle: 'خط المصحف',
    desc: 'Traditional calligraphy — the classic printed Mushaf style',
...
const styles = StyleSheet.create({
  ...
  badge:        { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 10, color: colors.mutedText, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 8 },
  heading:      { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 24, color: colors.darkText, lineHeight: 30, marginBottom: 6 },
  sub:          { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.mutedText, marginBottom: 22, lineHeight: 19 },
  ...
  cardTitleWrap:{ gap: 2 },
  cardTitle:    { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 16, color: colors.darkText },
  cardSubtitle: { fontFamily: 'NotoNaskhArabic_400Regular', fontSize: 14 },
  cardDesc:     { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 11, color: colors.mutedText, marginTop: 4, lineHeight: 16 },
  ...
  skipText:     { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 14, color: colors.placeholderText },
});
