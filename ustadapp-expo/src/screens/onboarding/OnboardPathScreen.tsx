...
const styles = StyleSheet.create({
  ...
  sub: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 13, color: colors.mutedText, marginBottom: 24 },
  card: {
  ...
  cardTitle: { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 15, color: colors.darkText, marginBottom: 3 },
  cardDesc: { fontFamily: 'PlusJakartaSans_400Regular', fontSize: 12, color: colors.mutedText, lineHeight: 17 },
  ...
  badge2Text: { fontFamily: 'PlusJakartaSans_700Bold', fontSize: 12 },
