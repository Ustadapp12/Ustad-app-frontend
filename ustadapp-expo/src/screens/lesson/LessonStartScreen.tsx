...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'PlusJakartaSans_700Bold', fontSize: 16, color: 'rgba(255,255,255,0.8)' },
  ...
  surahNum: { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 36, color: colors.gold },
  surahArabic: { fontFamily: 'NotoNaskhArabic_400Regular', fontSize: 16, color: 'rgba(255,255,255,0.9)', marginTop: 2 },
  surahName: { fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 12, color: 'rgba(255,255,255,0.7)', marginTop: 2 },
  ...
  speechText: { fontFamily: 'PlusJakartaSans_700Bold', fontSize: 13, color: '#374151', lineHeight: 19 },
  ...
  practiceTitle: { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 13, color: 'rgba(255,255,255,0.85)', marginBottom: 12 },
  ...
  practiceLabel: { flex: 1, fontFamily: 'PlusJakartaSans_600SemiBold', fontSize: 13, color: 'rgba(255,255,255,0.8)' },
  ...
  rewardText: { fontFamily: 'PlusJakartaSans_700Bold', fontSize: 12, color: 'rgba(255,255,255,0.75)' },
  ...
  startBtnText: { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 17, color: 'white' },
});
*/
